...
<body>
	...
	<div id="loader" style="background-color: #2b2b2b;display: fixed;top:0;width: 100%;height:100%;">
		<div id="tail">
	...
	<div id="body" class="container-fluid" style="background-color: white;">
			...
			<div class="row" id="home" style="background-color: white;width: 100%">
				...
				<div class="col-md-9">
					...
					<ul class="list-group" style="text-align: center;margin-top: 5%">
						...
						<li class = "list-gorup-item navbartabs">
				...
				<div class="col-md-4" id="steps">
					...
					<div class="col-md-12">
						<div id="step1">
							...
							<p>Upload the PDB structure of interest or Insert a PDB ID</p><br>
						</div>
					</div>
					<div class="col-md-12">
						<div id="step2">
			...
			<div class="row" style="background-color: #2b2b2b;" id="#Characteristics" >
				...
				<div class="col-md-8" style="background-color:#2b2b2b;color: black; padding-top:auto;padding-bottom: auto;margin-bottom: 6%;">
						...
						<div class="col-md-3">
							...
							<br>
							<input type="checkbox" name="Prosa" id="Pros"><p>Prosa</p><a id="Prosa" href="#run"> <span class="glyphicon glyphicon-info-sign" ></span></a>
							<br>
							<input type="checkbox" name="frst" id="frst" class="hidden"><p class="hidden" >FRST</p><a id="Frst" href="#run" class="hidden"> <span class="glyphicon glyphicon-info-sign" ></span></a>
							<br>
						...
						<div class="col-md-9" id="des" style="height: 450px;">
							...
							<div class="col-md-12" style="padding: 10px;padding-top: 0px">
								...
								<p id="warn" class="show">1- Please check the chains of your PDB file (The Tool will ignore any invalid chain) <br>2- It is Important to check that your PDB file do not contain any nucleotide. Otherwise the tool wont show promised results.<br>3- Once you press start your job is submitted.<br>4- Make sure the uploaded file name has a max of 6 character and no more than that (ex: ABCDEF.pdb)<br><br>Average Waiting Time is 9 minutes</p>
							...
							<div class="col-md-12" style="padding: 10px;padding-top: 0px">
								<p id="ProsaD" class="hidden">ProSa is a powerful tool in protein structure research. ProSa supports and guides your studies aimed at the determination of a protein's native fold. It is helpful for experimental structure determinations and modeling studies.Suppose you are confronted with the three-dimensional structure of a protein. The structure may have been determined by X-ray analysis or NMR-spectroscopy, it may be the result of modeling studies or it could be a nice looking structure deliberatly misfolded to fool specialists in protein structure theory.<br><a href="https://www.came.sbg.ac.at/publications/PSFG.17-355-362.pdf" style="color:#a7bba2" target="_blank">For More Info Click Here</a></p>
							</div>
							<div class="col-md-12" style="padding: 10px;padding-top: 0px">
								<p id="frstD" class="hidden">Scoring functions are widely used in the final step of model selection in protein structure prediction. A novel combination of four knowledge-based potentials recognizing different features of native protein structures is introduced and tested. The pairwise, solvation, hydrogen bond, and torsion angle potentials contain largely orthogonal information. Of these, the torsion angle potential is found to show the strongest correlation with model quality. Combining these features with a linear weighting function, it was possible to construct a robust energy function capable of discriminating native-like structures on several benchmarking sets <br><a href="https://www.ncbi.nlm.nih.gov/pubmed/16379537" style="color:#a7bba2" target="_blank">For More Info Click Here</a></p>
							</div>
							<div class="col-md-12">
							...
							<?php
								...
								$con=mysqli_connect("localhost","root","g.@.K.987","ODIN");
									if ($result5=mysqli_query($con,$sql5))
  									...
  									$sql6="SELECT count(*) FROM Ptools WHERE Ptools.User_ID like (SELECT ID FROM User WHERE User.Username like '$user') AND Ptools.Tool_name like 'Prosa' ";
								$con=mysqli_connect("localhost","root","g.@.K.987","ODIN");
									if ($result6=mysqli_query($con,$sql6))
  									...
  									$sql7="SELECT count(*) FROM Ptools WHERE Ptools.User_ID like (SELECT ID FROM User WHERE User.Username like '$user') AND Ptools.Tool_name like 'frst' ";
								$con=mysqli_connect("localhost","root","g.@.K.987","ODIN");
		...
		<script type="text/javascript">
			...
			element8 = document.getElementById('Prosa');
			element9 = document.getElementById('Frst');
			...
			delement8= document.getElementById('ProsaD');
			delement9= document.getElementById('frstD');
			...
			form.addEventListener("submit",function(){
				...
				if (delement8.classList.contains("show")) {
					delement8.classList.remove("show");
					delement8.classList.add("hidden");
				}
				if (delement9.classList.contains("show")) {
					delement9.classList.remove("show");
					delement9.classList.add("hidden");
				}
			});
			...
			element8.addEventListener("click",function(){
				delement6.classList.add("hidden");
				if (delement8.classList.contains("hidden")) {
    				delement8.classList.remove("hidden");
    				delement8.classList.add("show");
    				if (delement2.classList.contains("show")) {
    					delement2.classList.remove("show");
    					delement2.classList.add("hidden");
    				}
				...
				delement6.classList.add("hidden");
				if (delement9.classList.contains("hidden")) {
    				delement9.classList.remove("hidden");
    				delement9.classList.add("show");
    				if (delement2.classList.contains("show")) {
    					delement2.classList.remove("show");
    					delement2.classList.add("hidden");
    				}
		...
		<script type="text/javascript">
			...
			$('#sub').click(function() {
				...
				var t6=document.getElementById('Pros').checked;
				var t7=document.getElementById('frst').checked;
		...
		<script src="https://unpkg.com/ngl"></script>
    		<?php $sql="SELECT * FROM Ptools WHERE Ptools.Active like '1' and Ptools.User_ID like (SELECT ID FROM User WHERE User.Username like '$user') ORDER BY Ptools.ID asc";
							$con=mysqli_connect("localhost","root","g.@.K.987","ODIN");
							if ($result=mysqli_query($con,$sql))
  							{
								while($row = mysqli_fetch_assoc($result))
    			...
    			stage.loadFile(\"tools/$v9\").then(function (o) { 
