				...
				<div class="col-md-9">
					<ul class="list-group" style="text-align: center;margin-top: 5%">
						<li class="list-group-item navbartabs" >
							<a href="index.php#about" class="eventab" >About</a>
						</li>
						<li class="list-group-item navbartabs">
							<a href="index.php#Characteristics" class="oddtab" >Characteristics</a>
						</li>
						<li class="list-group-item navbartabs">
							<a href="index.php#makers" class="eventab">Makers</a>
						</li>
						<li class="list-group-item navbartabs">
							<a href="example.php" class="oddtab">Documentation</a>
						</li>
						<li class="list-group-item navbartabs">
							<a href="index.php#IA" class="eventab">Sign Up / Login</a>
						</li>
					</ul>
				</div>
